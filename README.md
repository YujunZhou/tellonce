...
**Status**: CC v1.0 + Codex v1 core
**测试**: CC 38+ unit + 12 chaos + 1 wrapper-level smoke; Codex 23 core unit
...
Open-source research artifact for studying in-session LLM preference enforcement.
Issues / PRs welcome via the project's GitHub repository.
