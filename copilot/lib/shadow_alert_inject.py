...
def build_inject_context(alerts):
    """Build additionalContext markdown from alert list. v2 (post continuation-repeat brainstorm idea G):
    internalize the reminder, don't encourage upfront preamble/apology/compliance declarations this turn.
    """
    if not alerts:
        return None
